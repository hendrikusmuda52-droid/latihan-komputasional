...
INSERT INTO "Question" (id, "gradeLevel", subject, question, "optionA", "optionB", "optionC", "optionD", "correctAnswer", explanation, category, "isActive", "questionType", "correctAnswers", "matchPairs", "shortAnswer", "essayAnswer", "levelKognitif", "pembahasanBenar", "analisisDistraktor", "cpId", "tpId", "createdAt", "updatedAt") VALUES
('q_tugas2_11dkv_isian_001', '11DKV', 'Mata Pelajaran Pilihan', 'Aturan komposisi yang membagi frame menjadi 3 bagian horizontal dan 3 vertikal (9 kotak, 4 titik temu) disebut Rule of...', 'setengah', 'seperempat', 'seperlima', 'sepersepuluh', 2, 'Rule of Thirds — bagi frame jadi 9 kotak, 4 power points. ''Thirds'' (jamak) paling tepat, ''Third'' (tunggal) accepted.', 'Komposisi & Estetika', true, 'isian_singkat', '[]', '[]', 'third|thirds|thirds', '', 'C3', 'Jawaban: third|thirds|thirds. Rule of Thirds — bagi frame jadi 9 kotak, 4 power points. ''Thirds'' (jamak) paling tepat, ''Third'' (tunggal) accepted.', 'Skor: BEST (thirds)=100, RIGHT (third,thirds)=50, lain=0', 'cp_dkv_pil_11_2', 'tp_dkv_pil_11_2_1', NOW(), NOW())
ON CONFLICT (id) DO NOTHING;

-- Isian #002 (C3 - Komposisi & Estetika)
INSERT INTO "Question" (id, "gradeLevel", subject, question, "optionA", "optionB", "optionC", "optionD", "correctAnswer", explanation, category, "isActive", "questionType", "correctAnswers", "matchPairs", "shortAnswer", "essayAnswer", "levelKognitif", "pembahasanBenar", "analisisDistraktor", "cpId", "tpId", "createdAt", "updatedAt") VALUES
('q_tugas2_11dkv_isian_002', '11DKV', 'Mata Pelajaran Pilihan', 'Pengaturan aperture yang BESAR (misalnya f/1.4, f/1.8, f/2.8) menghasilkan depth of field yang... (gunakan istilah: dangkal/dalam)', 'lebar', 'tegas', 'runcing', 'keras', 2, 'Aperture besar = DOF dangkal. Background kabur. ''Dangkal'' paling tepat (istilah Indonesia), ''Tipis'' accepted (sinonim).', 'Komposisi & Estetika', true, 'isian_singkat', '[]', '[]', 'dangkal|tipis|dangkal', '', 'C3', 'Jawaban: dangkal|tipis|dangkal. Aperture besar = DOF dangkal. Background kabur. ''Dangkal'' paling tepat (istilah Indonesia), ''Tipis'' accepted (sinonim).', 'Skor: BEST (dangkal)=100, RIGHT (dangkal,tipis)=50, lain=0', 'cp_dkv_pil_11_2', 'tp_dkv_pil_11_2_1', NOW(), NOW())
ON CONFLICT (id) DO NOTHING;

-- Isian #003 (C3 - Komposisi & Estetika)
INSERT INTO "Question" (id, "gradeLevel", subject, question, "optionA", "optionB", "optionC", "optionD", "correctAnswer", explanation, category, "isActive", "questionType", "correctAnswers", "matchPairs", "shortAnswer", "essayAnswer", "levelKognitif", "pembahasanBenar", "analisisDistraktor", "cpId", "tpId", "createdAt", "updatedAt") VALUES
('q_tugas2_11dkv_isian_003', '11DKV', 'Mata Pelajaran Pilihan', 'Warna komplementer warna MERAH adalah... (sebut nama warna)', 'biru', 'kuning', 'ungu', 'oranye', 2, 'Merah-hijau = komplementer (berseberangan color wheel). ''Hijau'' paling tepat (istilah Indonesia).', 'Komposisi & Estetika', true, 'isian_singkat', '[]', '[]', 'hijau|hijau daun|hijau', '', 'C3', 'Jawaban: hijau|hijau daun|hijau. Merah-hijau = komplementer (berseberangan color wheel). ''Hijau'' paling tepat (istilah Indonesia).', 'Skor: BEST (hijau)=100, RIGHT (hijau,hijau daun)=50, lain=0', 'cp_dkv_pil_11_2', 'tp_dkv_pil_11_2_1', NOW(), NOW())
ON CONFLICT (id) DO NOTHING;

-- Isian #004 (C3 - Komposisi & Estetika)
INSERT INTO "Question" (id, "gradeLevel", subject, question, "optionA", "optionB", "optionC", "optionD", "correctAnswer", explanation, category, "isActive", "questionType", "correctAnswers", "matchPairs", "shortAnswer", "essayAnswer", "levelKognitif", "pembahasanBenar", "analisisDistraktor", "cpId", "tpId", "createdAt", "updatedAt") VALUES
('q_tugas2_11dkv_isian_004', '11DKV', 'Mata Pelajaran Pilihan', 'Garis yang memandu mata pengamat ke subjek disebut garis...', 'kurva', 'titik', 'bentuk', 'warna', 2, 'Garis pandu (leading lines) — garis yang memandu mata. ''Pandu'' paling tepat (Indonesia), ''Pemandu'' accepted (sinonim).', 'Komposisi & Estetika', true, 'isian_singkat', '[]', '[]', 'pandu|pemandu|pandu', '', 'C3', 'Jawaban: pandu|pemandu|pandu. Garis pandu (leading lines) — garis yang memandu mata. ''Pandu'' paling tepat (Indonesia), ''Pemandu'' accepted (sinonim).', 'Skor: BEST (pandu)=100, RIGHT (pandu,pemandu)=50, lain=0', 'cp_dkv_pil_11_2', 'tp_dkv_pil_11_2_1', NOW(), NOW())
ON CONFLICT (id) DO NOTHING;

-- Isian #005 (C3 - Komposisi & Estetika)
INSERT INTO "Question" (id, "gradeLevel", subject, question, "optionA", "optionB", "optionC", "optionD", "correctAnswer", explanation, category, "isActive", "questionType", "correctAnswers", "matchPairs", "shortAnswer", "essayAnswer", "levelKognitif", "pembahasanBenar", "analisisDistraktor", "cpId", "tpId", "createdAt", "updatedAt") VALUES
('q_tugas2_11dkv_isian_005', '11DKV', 'Mata Pelajaran Pilihan', 'Jarak fokus yang menghasilkan background kabur (bokeh) disebut kedalaman...', 'pandangan', 'fokus', 'lensa', 'kabur', 2, 'Kedalaman ruang (depth of field). DOF dangkal = background kabur. ''Ruang'' paling tepat (Indonesia), ''Bidang'' accepted (sinonim).', 'Komposisi & Estetika', true, 'isian_singkat', '[]', '[]', 'ruang|bidang|ruang', '', 'C3', 'Jawaban: ruang|bidang|ruang. Kedalaman ruang (depth of field). DOF dangkal = background kabur. ''Ruang'' paling tepat (Indonesia), ''Bidang'' accepted (sinonim).', 'Skor: BEST (ruang)=100, RIGHT (ruang,bidang)=50, lain=0', 'cp_dkv_pil_11_2', 'tp_dkv_pil_11_2_1', NOW(), NOW())
ON CONFLICT (id) DO NOTHING;

-- Isian #006 (C4 - Komposisi & Estetika)
INSERT INTO "Question" (id, "gradeLevel", subject, question, "optionA", "optionB", "optionC", "optionD", "correctAnswer", explanation, category, "isActive", "questionType", "correctAnswers", "matchPairs", "shortAnswer", "essayAnswer", "levelKognitif", "pembahasanBenar", "analisisDistraktor", "cpId", "tpId", "createdAt", "updatedAt") VALUES
('q_tugas2_11dkv_isian_006', '11DKV', 'Mata Pelajaran Pilihan', 'Komposisi yang menggunakan elemen sekitar (jendela, daun, pintu) sebagai bingkai alami subjek disebut...', 'pangkas', 'perbesar', 'filter', 'tepi', 2, 'Bingkai (framing) — menggunakan elemen sekitar sebagai bingkai alami. ''Bingkai'' paling tepat (Indonesia).', 'Komposisi & Estetika', true, 'isian_singkat', '[]', '[]', 'bingkai|bingkai alami|bingkai', '', 'C4', 'Jawaban: bingkai|bingkai alami|bingkai. Bingkai (framing) — menggunakan elemen sekitar sebagai bingkai alami. ''Bingkai'' paling tepat (Indonesia).', 'Skor: BEST (bingkai)=100, RIGHT (bingkai,bingkai alami)=50, lain=0', 'cp_dkv_pil_11_2', 'tp_dkv_pil_11_2_1', NOW(), NOW())
ON CONFLICT (id) DO NOTHING;

-- Isian #007 (C4 - Komposisi & Estetika)
INSERT INTO "Question" (id, "gradeLevel", subject, question, "optionA", "optionB", "optionC", "optionD", "correctAnswer", explanation, category, "isActive", "questionType", "correctAnswers", "matchPairs", "shortAnswer", "essayAnswer", "levelKognitif", "pembahasanBenar", "analisisDistraktor", "cpId", "tpId", "createdAt", "updatedAt") VALUES
('q_tugas2_11dkv_isian_007', '11DKV', 'Mata Pelajaran Pilihan', 'Foto pantulan cermin di danau menghasilkan komposisi yang disebut...', 'kacau', 'acak', 'asimetri', 'distorsi', 2, 'Simetri — pantulan menciptakan simetri refleksi. ''Simetri'' paling tepat (Indonesia), ''Seimbang'' accepted (sinonim).', 'Komposisi & Estetika', true, 'isian_singkat', '[]', '[]', 'simetri|seimbang|simetri', '', 'C4', 'Jawaban: simetri|seimbang|simetri. Simetri — pantulan menciptakan simetri refleksi. ''Simetri'' paling tepat (Indonesia), ''Seimbang'' accepted (sinonim).', 'Skor: BEST (simetri)=100, RIGHT (simetri,seimbang)=50, lain=0', 'cp_dkv_pil_11_2', 'tp_dkv_pil_11_2_1', NOW(), NOW())
ON CONFLICT (id) DO NOTHING;

-- Isian #008 (C3 - Komposisi & Estetika)
INSERT INTO "Question" (id, "gradeLevel", subject, question, "optionA", "optionB", "optionC", "optionD", "correctAnswer", explanation, category, "isActive", "questionType", "correctAnswers", "matchPairs", "shortAnswer", "essayAnswer", "levelKognitif", "pembahasanBenar", "analisisDistraktor", "cpId", "tpId", "createdAt", "updatedAt") VALUES
('q_tugas2_11dkv_isian_008', '11DKV', 'Mata Pelajaran Pilihan', 'Pengaturan aperture yang KECIL (f/16, f/22) menghasilkan depth of field yang... (istilah: dalam)', 'sempit', 'tipis', 'rendah', 'cepat', 2, 'Aperture kecil = DOF dalam. Semua tajam. ''Dalam'' paling tepat (istilah Indonesia), ''Mendalam'' accepted (sinonim).', 'Komposisi & Estetika', true, 'isian_singkat', '[]', '[]', 'dalam|mendalam|dalam', '', 'C3', 'Jawaban: dalam|mendalam|dalam. Aperture kecil = DOF dalam. Semua tajam. ''Dalam'' paling tepat (istilah Indonesia), ''Mendalam'' accepted (sinonim).', 'Skor: BEST (dalam)=100, RIGHT (dalam,mendalam)=50, lain=0', 'cp_dkv_pil_11_2', 'tp_dkv_pil_11_2_1', NOW(), NOW())
ON CONFLICT (id) DO NOTHING;

-- Isian #009 (C3 - Komposisi & Estetika)
INSERT INTO "Question" (id, "gradeLevel", subject, question, "optionA", "optionB", "optionC", "optionD", "correctAnswer", explanation, category, "isActive", "questionType", "correctAnswers", "matchPairs", "shortAnswer", "essayAnswer", "levelKognitif", "pembahasanBenar", "analisisDistraktor", "cpId", "tpId", "createdAt", "updatedAt") VALUES
('q_tugas2_11dkv_isian_009', '11DKV', 'Mata Pelajaran Pilihan', 'Pola berulang dari benda-benda identik (misal: susunan kacamata di etalase) disebut komposisi...', 'kacau', 'gangguan', 'rusak', 'berserakan', 2, 'Pola (pattern) — benda berulang membentuk komposisi menarik. ''Pola'' paling tepat (Indonesia).', 'Komposisi & Estetika', true, 'isian_singkat', '[]', '[]', 'pola|pola berulang|pola', '', 'C3', 'Jawaban: pola|pola berulang|pola. Pola (pattern) — benda berulang membentuk komposisi menarik. ''Pola'' paling tepat (Indonesia).', 'Skor: BEST (pola)=100, RIGHT (pola,pola berulang)=50, lain=0', 'cp_dkv_pil_11_2', 'tp_dkv_pil_11_2_1', NOW(), NOW())
ON CONFLICT (id) DO NOTHING;

-- Isian #010 (C3 - Komposisi & Estetika)
INSERT INTO "Question" (id, "gradeLevel", subject, question, "optionA", "optionB", "optionC", "optionD", "correctAnswer", explanation, category, "isActive", "questionType", "correctAnswers", "matchPairs", "shortAnswer", "essayAnswer", "levelKognitif", "pembahasanBenar", "analisisDistraktor", "cpId", "tpId", "createdAt", "updatedAt") VALUES
('q_tugas2_11dkv_isian_010', '11DKV', 'Mata Pelajaran Pilihan', 'Ruang kosong di sekitar subjek yang menonjolkan subjek disebut ruang...', 'positif', 'hampa', 'penuh', 'ramai', 2, 'Ruang negatif (negative space) — ruang kosong yang menonjolkan subjek. ''Negatif'' paling tepat (Indonesia), ''Kosong'' accepted (sinonim).', 'Komposisi & Estetika', true, 'isian_singkat', '[]', '[]', 'negatif|kosong|negatif', '', 'C3', 'Jawaban: negatif|kosong|negatif. Ruang negatif (negative space) — ruang kosong yang menonjolkan subjek. ''Negatif'' paling tepat (Indonesia), ''Kosong'' accepted (sinonim).', 'Skor: BEST (negatif)=100, RIGHT (negatif,kosong)=50, lain=0', 'cp_dkv_pil_11_2', 'tp_dkv_pil_11_2_1', NOW(), NOW())
ON CONFLICT (id) DO NOTHING;
