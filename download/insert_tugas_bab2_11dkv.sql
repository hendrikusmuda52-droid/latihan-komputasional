...
INSERT INTO "Question" (id, "gradeLevel", subject, question, "optionA", "optionB", "optionC", "optionD", "correctAnswer", explanation, category, "isActive", "questionType", "correctAnswers", "matchPairs", "shortAnswer", "essayAnswer", "levelKognitif", "pembahasanBenar", "analisisDistraktor", "cpId", "tpId", "createdAt", "updatedAt") VALUES
('q_tugas2_11dkv_isian_001', '11DKV', 'Mata Pelajaran Pilihan', 'Aturan komposisi yang membagi frame menjadi 3 bagian horizontal dan 3 vertikal (9 kotak, 4 titik temu) disebut Rule of...', 'half', 'quarter', 'fifth', 'tenth', 2, 'Rule of Thirds — bagi frame jadi 9 kotak, 4 power points. ''Thirds'' (jamak) paling tepat, ''Third'' (tunggal) accepted.', 'Komposisi & Estetika', true, 'isian_singkat', '[]', '[]', 'third|thirds|thirds', '', 'C3', 'Jawaban: third|thirds|thirds. Rule of Thirds — bagi frame jadi 9 kotak, 4 power points. ''Thirds'' (jamak) paling tepat, ''Third'' (tunggal) accepted.', 'Skor: BEST (thirds)=100, RIGHT (third,thirds)=50, lain=0', 'cp_dkv_pil_11_2', 'tp_dkv_pil_11_2_1', NOW(), NOW())
ON CONFLICT (id) DO NOTHING;

-- Isian #002 (C3 - Komposisi & Estetika)
INSERT INTO "Question" (id, "gradeLevel", subject, question, "optionA", "optionB", "optionC", "optionD", "correctAnswer", explanation, category, "isActive", "questionType", "correctAnswers", "matchPairs", "shortAnswer", "essayAnswer", "levelKognitif", "pembahasanBenar", "analisisDistraktor", "cpId", "tpId", "createdAt", "updatedAt") VALUES
('q_tugas2_11dkv_isian_002', '11DKV', 'Mata Pelajaran Pilihan', 'Pengaturan aperture yang BESAR (misalnya f/1.4, f/1.8, f/2.8) menghasilkan depth of field yang... (gunakan istilah: dangkal/dalam)', 'lebar', 'tegas', 'runcing', 'keras', 2, 'Aperture besar = DOF dangkal (shallow). Background kabur. ''Dangkal'' paling tepat (istilah Indonesia).', 'Komposisi & Estetika', true, 'isian_singkat', '[]', '[]', 'dangkal|shallow|dangkal', '', 'C3', 'Jawaban: dangkal|shallow|dangkal. Aperture besar = DOF dangkal (shallow). Background kabur. ''Dangkal'' paling tepat (istilah Indonesia).', 'Skor: BEST (dangkal)=100, RIGHT (dangkal,shallow)=50, lain=0', 'cp_dkv_pil_11_2', 'tp_dkv_pil_11_2_1', NOW(), NOW())
ON CONFLICT (id) DO NOTHING;

-- Isian #003 (C3 - Komposisi & Estetika)
INSERT INTO "Question" (id, "gradeLevel", subject, question, "optionA", "optionB", "optionC", "optionD", "correctAnswer", explanation, category, "isActive", "questionType", "correctAnswers", "matchPairs", "shortAnswer", "essayAnswer", "levelKognitif", "pembahasanBenar", "analisisDistraktor", "cpId", "tpId", "createdAt", "updatedAt") VALUES
('q_tugas2_11dkv_isian_003', '11DKV', 'Mata Pelajaran Pilihan', 'Warna komplementer warna MERAH adalah... (sebut nama warna)', 'biru', 'kuning', 'ungu', 'oranye', 2, 'Merah-hijau = komplementer (berseberangan color wheel). ''Hijau'' (Indonesia) paling tepat.', 'Komposisi & Estetika', true, 'isian_singkat', '[]', '[]', 'hijau|green|hijau', '', 'C3', 'Jawaban: hijau|green|hijau. Merah-hijau = komplementer (berseberangan color wheel). ''Hijau'' (Indonesia) paling tepat.', 'Skor: BEST (hijau)=100, RIGHT (hijau,green)=50, lain=0', 'cp_dkv_pil_11_2', 'tp_dkv_pil_11_2_1', NOW(), NOW())
ON CONFLICT (id) DO NOTHING;

-- Isian #004 (C3 - Komposisi & Estetika)
INSERT INTO "Question" (id, "gradeLevel", subject, question, "optionA", "optionB", "optionC", "optionD", "correctAnswer", explanation, category, "isActive", "questionType", "correctAnswers", "matchPairs", "shortAnswer", "essayAnswer", "levelKognitif", "pembahasanBenar", "analisisDistraktor", "cpId", "tpId", "createdAt", "updatedAt") VALUES
('q_tugas2_11dkv_isian_004', '11DKV', 'Mata Pelajaran Pilihan', 'Garis yang memandu mata pengamat ke subjek disebut... (istilah Inggris: leading...)', 'curves', 'dots', 'shapes', 'colors', 2, 'Leading Lines — garis yang memandu mata. ''Lines'' (English, full term ''leading lines'') paling tepat.', 'Komposisi & Estetika', true, 'isian_singkat', '[]', '[]', 'lines|garis|lines', '', 'C3', 'Jawaban: lines|garis|lines. Leading Lines — garis yang memandu mata. ''Lines'' (English, full term ''leading lines'') paling tepat.', 'Skor: BEST (lines)=100, RIGHT (lines,garis)=50, lain=0', 'cp_dkv_pil_11_2', 'tp_dkv_pil_11_2_1', NOW(), NOW())
ON CONFLICT (id) DO NOTHING;

-- Isian #005 (C3 - Komposisi & Estetika)
INSERT INTO "Question" (id, "gradeLevel", subject, question, "optionA", "optionB", "optionC", "optionD", "correctAnswer", explanation, category, "isActive", "questionType", "correctAnswers", "matchPairs", "shortAnswer", "essayAnswer", "levelKognitif", "pembahasanBenar", "analisisDistraktor", "cpId", "tpId", "createdAt", "updatedAt") VALUES
('q_tugas2_11dkv_isian_005', '11DKV', 'Mata Pelajaran Pilihan', 'Jarak fokus yang menghasilkan background kabur (bokeh) disebut depth of...', 'view', 'focus', 'lens', 'blur', 2, 'Depth of Field (DOF). DOF dangkal = background kabur. ''Field'' (full term ''depth of field'') paling tepat.', 'Komposisi & Estetika', true, 'isian_singkat', '[]', '[]', 'field|dof|field', '', 'C3', 'Jawaban: field|dof|field. Depth of Field (DOF). DOF dangkal = background kabur. ''Field'' (full term ''depth of field'') paling tepat.', 'Skor: BEST (field)=100, RIGHT (field,dof)=50, lain=0', 'cp_dkv_pil_11_2', 'tp_dkv_pil_11_2_1', NOW(), NOW())
ON CONFLICT (id) DO NOTHING;

-- Isian #006 (C4 - Komposisi & Estetika)
INSERT INTO "Question" (id, "gradeLevel", subject, question, "optionA", "optionB", "optionC", "optionD", "correctAnswer", explanation, category, "isActive", "questionType", "correctAnswers", "matchPairs", "shortAnswer", "essayAnswer", "levelKognitif", "pembahasanBenar", "analisisDistraktor", "cpId", "tpId", "createdAt", "updatedAt") VALUES
('q_tugas2_11dkv_isian_006', '11DKV', 'Mata Pelajaran Pilihan', 'Komposisi yang menggunakan elemen sekitar (jendela, daun, pintu) sebagai bingkai alami subjek disebut...', 'crop', 'zoom', 'filter', 'border', 2, 'Framing — menggunakan elemen sekitar sebagai bingkai alami. ''Framing'' (istilah fotografi) paling tepat.', 'Komposisi & Estetika', true, 'isian_singkat', '[]', '[]', 'framing|bingkai|framing', '', 'C4', 'Jawaban: framing|bingkai|framing. Framing — menggunakan elemen sekitar sebagai bingkai alami. ''Framing'' (istilah fotografi) paling tepat.', 'Skor: BEST (framing)=100, RIGHT (framing,bingkai)=50, lain=0', 'cp_dkv_pil_11_2', 'tp_dkv_pil_11_2_1', NOW(), NOW())
ON CONFLICT (id) DO NOTHING;

-- Isian #007 (C4 - Komposisi & Estetika)
INSERT INTO "Question" (id, "gradeLevel", subject, question, "optionA", "optionB", "optionC", "optionD", "correctAnswer", explanation, category, "isActive", "questionType", "correctAnswers", "matchPairs", "shortAnswer", "essayAnswer", "levelKognitif", "pembahasanBenar", "analisisDistraktor", "cpId", "tpId", "createdAt", "updatedAt") VALUES
('q_tugas2_11dkv_isian_007', '11DKV', 'Mata Pelajaran Pilihan', 'Foto pantulan cermin di danau menghasilkan komposisi yang disebut...', 'chaos', 'random', 'asymmetry', 'distortion', 2, 'Symmetry (simetri) — pantulan menciptakan simetri refleksi. ''Symmetry'' (English) paling tepat.', 'Komposisi & Estetika', true, 'isian_singkat', '[]', '[]', 'symmetry|simetri|symmetry', '', 'C4', 'Jawaban: symmetry|simetri|symmetry. Symmetry (simetri) — pantulan menciptakan simetri refleksi. ''Symmetry'' (English) paling tepat.', 'Skor: BEST (symmetry)=100, RIGHT (symmetry,simetri)=50, lain=0', 'cp_dkv_pil_11_2', 'tp_dkv_pil_11_2_1', NOW(), NOW())
ON CONFLICT (id) DO NOTHING;

-- Isian #008 (C3 - Komposisi & Estetika)
INSERT INTO "Question" (id, "gradeLevel", subject, question, "optionA", "optionB", "optionC", "optionD", "correctAnswer", explanation, category, "isActive", "questionType", "correctAnswers", "matchPairs", "shortAnswer", "essayAnswer", "levelKognitif", "pembahasanBenar", "analisisDistraktor", "cpId", "tpId", "createdAt", "updatedAt") VALUES
('q_tugas2_11dkv_isian_008', '11DKV', 'Mata Pelajaran Pilihan', 'Pengaturan aperture yang KECIL (f/16, f/22) menghasilkan depth of field yang... (istilah: dalam)', 'sempit', 'tipis', 'rendah', 'cepat', 2, 'Aperture kecil = DOF dalam (deep). Semua tajam. ''Dalam'' (istilah Indonesia) paling tepat.', 'Komposisi & Estetika', true, 'isian_singkat', '[]', '[]', 'dalam|deep|dalam', '', 'C3', 'Jawaban: dalam|deep|dalam. Aperture kecil = DOF dalam (deep). Semua tajam. ''Dalam'' (istilah Indonesia) paling tepat.', 'Skor: BEST (dalam)=100, RIGHT (dalam,deep)=50, lain=0', 'cp_dkv_pil_11_2', 'tp_dkv_pil_11_2_1', NOW(), NOW())
ON CONFLICT (id) DO NOTHING;

-- Isian #009 (C3 - Komposisi & Estetika)
INSERT INTO "Question" (id, "gradeLevel", subject, question, "optionA", "optionB", "optionC", "optionD", "correctAnswer", explanation, category, "isActive", "questionType", "correctAnswers", "matchPairs", "shortAnswer", "essayAnswer", "levelKognitif", "pembahasanBenar", "analisisDistraktor", "cpId", "tpId", "createdAt", "updatedAt") VALUES
('q_tugas2_11dkv_isian_009', '11DKV', 'Mata Pelajaran Pilihan', 'Pola berulang dari benda-benda identik (misal: susunan kacamata di etalase) disebut komposisi...', 'chaos', 'noise', 'glitch', 'scatter', 2, 'Pattern (pola) — benda berulang membentuk komposisi menarik. ''Pattern'' (English) paling tepat.', 'Komposisi & Estetika', true, 'isian_singkat', '[]', '[]', 'pattern|pola|pattern', '', 'C3', 'Jawaban: pattern|pola|pattern. Pattern (pola) — benda berulang membentuk komposisi menarik. ''Pattern'' (English) paling tepat.', 'Skor: BEST (pattern)=100, RIGHT (pattern,pola)=50, lain=0', 'cp_dkv_pil_11_2', 'tp_dkv_pil_11_2_1', NOW(), NOW())
ON CONFLICT (id) DO NOTHING;

-- Isian #010 (C3 - Komposisi & Estetika)
INSERT INTO "Question" (id, "gradeLevel", subject, question, "optionA", "optionB", "optionC", "optionD", "correctAnswer", explanation, category, "isActive", "questionType", "correctAnswers", "matchPairs", "shortAnswer", "essayAnswer", "levelKognitif", "pembahasanBenar", "analisisDistraktor", "cpId", "tpId", "createdAt", "updatedAt") VALUES
('q_tugas2_11dkv_isian_010', '11DKV', 'Mata Pelajaran Pilihan', 'Ruang kosong di sekitar subjek yang menonjolkan subjek disebut... space (istilah Inggris)', 'positive', 'blank', 'empty', 'void', 2, 'Negative Space — ruang kosong yang menonjolkan subjek. ''Negative'' (full term ''negative space'') paling tepat.', 'Komposisi & Estetika', true, 'isian_singkat', '[]', '[]', 'negative|negatif|negative', '', 'C3', 'Jawaban: negative|negatif|negative. Negative Space — ruang kosong yang menonjolkan subjek. ''Negative'' (full term ''negative space'') paling tepat.', 'Skor: BEST (negative)=100, RIGHT (negative,negatif)=50, lain=0', 'cp_dkv_pil_11_2', 'tp_dkv_pil_11_2_1', NOW(), NOW())
ON CONFLICT (id) DO NOTHING;
