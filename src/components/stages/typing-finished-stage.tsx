            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-slate-600 mb-4">
                  Kamu akan mengerjakan soal pilihan ganda tentang berpikir
                  komputasional. Baca pertanyaan dengan teliti sebelum menjawab.
                </p>
                <div className="flex flex-wrap gap-4 text-sm text-slate-700 mb-4">
                  ...
                  <span className="flex items-center gap-1">
                    <Brain className="w-4 h-4 text-teal-600" /> Soal HOTS
                  </span>
                </div>
                <Button
                  size="lg"
